...
| 15:00-15:30 | Karlin 4 | NETCONF/RESTCONF-next | OPS/MGMT | perander@cisco.com | Start categorizing open issues to identify what needs YANG-next, new protocol versions, completed work, can be done extending current protocol versions, uninteresting work(?). | https://ietf.webex.com/meet/sidemeetingietf1 | TBD |
