...
| **Time** | **Room** | **Meeting Name** | **Area** | **Contact** | **Meeting Description** | **Conferencing Link** | **Calendar Invite (.ics)** |
|----------|----------|------------------|----------|-------------|-------------------------|-----------------------|----------|
| 9:30-10:50 |   Golden Gate 4     | Protocol Performance over Satellite | TSV | G Fairhurst | Side for participant to discuss transport protocol performance over deployed satellite systems |  https://meet.jit.si/IETF117-satellite-perf  |     TBD   |
