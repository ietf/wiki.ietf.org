...
- [Ensaimada](https://spanishsabores.com/ensaimada-recipe/). Usually filled with pumkin jam (cabello de angel), but also with cream, other sweets, however is common to find savory variations, for example sobrasada.
