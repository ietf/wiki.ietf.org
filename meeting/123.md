...
Nonetheless, the bus network (EMT) in Madrid is very extensive, and it can be useful specially if you get a Public Transport Card. [Information about the buses](https://www.emtmadrid.es/Bloques-EMT/Aeropuerto.aspx?lang=en-GB). Buses (not Metro) can also be payed directly with cash (up to 5 €) or credit card.
