...
### Cold Soups
- [Gazpacho](https://spanishsabores.com/recipe-gazpacho-andaluz/#ingredients). Refreshing and only vegetable (mainly tomato).
...
### Salads or so ...
They can be a dish on their own, better several of them and share!
- Ensaladilla rusa. It can have tuna or belly (not just from tuna).
- Sanfaina.
- Pisto.
- Escalivada.
- Patatas bravas.
