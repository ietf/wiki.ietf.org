...
Note that the Hotel Luze Castellana may also identify as the Senator Castellana on some booking systems
...
The Madrid Airport is connected to the city of Madrid via the [Pink Metro Line 8](https://www.metromadrid.es/en/linea/linea-8). This line ends at the Nuevos Ministerios Station, where you would need to transfer to the [Dark Blue Metro Line 10](https://www.metromadrid.es/en/linea/linea-10), direction "Hospital Infanta Sofia". The closest station to the Meliá Castilla is "Cuzco" (5 minutes walking to the Melíá Castilla), just 2 stations from Nuevos Ministerios.
