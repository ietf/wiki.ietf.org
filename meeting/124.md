...
- **Weekly, all modes** - A weekly ($32.00, Monday to Sunday) transit pass is also available **but requires a $6 [OPUS card](#purchasing-an-opus-card) first.** The OPUS card can then be reloaded at any time via a smartphone using the [Chrono mobile app](https://www.artm.quebec/en/chrono-mobile-application/).
