...
It can be accessed via the metro (`2`/🟢 green line) at station Pie-IX and Viau.

From the meeting venue, take the `1`/🟠 orange metro line from the **Bonaventure** station (towards Montmorency) to the **Berry-UQAM** station and transfer to the `2`/🟢 green line towards **Honoré-Beaugrand**. Exit at station **Pie-IX** (or **Viau**).
