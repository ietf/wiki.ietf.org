...
| 18:30-19:30  | G301 | Missing Elements for Decentralized and Usable Privacy (MEDUP) | N/A | [Hernâni Marques](hernani.marques@pep.foundation) | Discuss Internet-Drafts produced in recent times (cf. [medup@ietf.org archives](https://www.ietf.org/mailman/listinfo/MEDUP)). | Online participation possible through [Jitsi](https://meet.zrh.init7.net/medup). | TBA |
{.dense}
