...
## Pharmacy
Many things you might expect to find at 7/11 or a grocery store might only be available in pharmacies. Think of the square green cross with some variation of "Apoteka". There are many near the hotel. It's going to be 95 Farenheit / 35 Celsius during this week. This might lead to "athlete's foot" and related conditions. The remedy goes by the name "Canesten" here (the US brand is Lotrimin). Written here so you don't have to ask.
...
in March there is a special promotion, 10 rides for 390 thb, if one remains in the central region of the bts system: https://www.bts.co.th/eng/news/news-marketing-view.html?id=7qT9j5oW7m4zQ2J/7mG5ww==
...
## What is this place supposed to be called?

A good question. The name "Bangkok" is sort of like calling "New York City" by the name "Brooklyn". Locals say "Krung Thep", short for "Krung Thep Maha Nakhon", and an even longer formal name. It is not offensive to say "Bangkok", because the local term requires some tonal pronunciation that most will probably miss. In informal written communication, it is ok to write "BKK".

## Fun Stuff

- GameBar Odyssey - [Reddit thread](https://www.reddit.com/r/Bangkok/comments/1j2jov1/gamebar_odyssey_i_have_finally_found_this_great/), [Google map](https://maps.app.goo.gl/kEziYs6evXkVSnALA); a retro video game bar with lots of variety

- [Coin Museum](https://www.atlasobscura.com/places/bangkok-coin-museum-thailand)
