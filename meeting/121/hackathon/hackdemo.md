...
|Interface to In-Network Functions (I2INF) Project| Jaehoon (Paul) Jeong|pauljeong@skku.edu|[I2INF Framework](https://datatracker.ietf.org/doc/draft-jeong-opsawg-i2inf-framework/) <br> [IBM Framework for SDV in ITS](https://datatracker.ietf.org/doc/draft-jeong-opsawg-intent-based-sdv-framework/)<br>[I2INF Problem Statement](https://datatracker.ietf.org/doc/draft-jeong-opsawg-i2inf-problem-statement/)|
|---|---|---|---|
|---|---|---|---|
|---|---|---|---|
|---|---|---|---|
