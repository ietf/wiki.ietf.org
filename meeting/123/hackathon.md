...
The [code and proofs](https://github.com/project-everest/everparse/tree/_taramana_cbor_bij) are open-source and available on GitHub, along with a [pre-built Docker image](https://github.com/tahina-pro/quackyducky/pkgs/container/evercbor). Further details in the [paper](https://arxiv.org/abs/2505.17335) that we posted on arXiv, and that has just been accepted to [ACM CCS 2025](https://www.sigsac.org/ccs/CCS2025/).
- **Goals**
