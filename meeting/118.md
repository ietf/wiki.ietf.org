...
Rather unusually, Prague Airport provides an Uber Airport service.  This Uber but with added security to ensure only specific Uber cars, branded as Uber Airport, can provide it and there are a number of these cars lined up outside the terminal much like taxis. There are two ways to book this:
