...
[Prague Public Transport](https://www.pragueexperience.com/travel/public-transport.asp) - Bus, tram, and Metro. Single ticket (90 minutes), 1-day, 3-day, and 1-month passes available (children under 9 ride free with adult). Tickets are half price for people 60-64, over 65 are free. Have an ID to prove your age.
...
The official (cash) currency of the Czech Republic is the Czech crown (koruna, with the international abbreviation CZK). [More about the Koruna with images of the different bank notes](http://www.prague.net/blog/article/60/money-money-money-czech-crown). Euros are also widel accepted.
