...
### Taxi :taxi:
Rather unusually, Prague Airport provides an [Uber Airport service](https://www.prg.aero/en/taxi). This is Uber but with added security to ensure only specific Uber cars, branded as Uber Airport, can provide it and there are a number of these cars lined up outside the terminal much like taxis. There are two ways to book this ([more details](https://www.prg.aero/en/taxi)):
...
* From an Uber kiosk or the Uber desk, where you pay and are given a receipt that you then show to the first Uber Airport driver on the rank.
