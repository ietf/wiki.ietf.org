...
### Taxi :taxi:
The official taxi service for Prague Airport is [Uber Airport](https://www.prg.aero/en/taxi) and there are a number of branded "Uber Airport" cars lined up outside the terminal just like taxis. There are two ways to book this ([more details](https://www.prg.aero/en/taxi)):
* Using the Uber app.  Once you have selected "Uber Airport" and booked the ride, the app will display a six digit code, which then needs to be shown to the first Uber Airport driver on the rank who then types it into their app and the ride is confirmed.
* From an Uber kiosk or the Uber desk in the terminal building, where you pay and are given a receipt that you then show to the first Uber Airport driver on the rank.

Prague also has a local competitor to Uber [LiftAgo](http://www.liftago.com/). Pricing is roughly same as taxi services.
...
> Please note, there are multiple people offering "taxi" rides to anyone who gets off a plane.  It is strongly recommended that you do not use any of these people and only use the other services listed on this page. {.is-warning}
...
## Exercise
* [Hotel Swimming Pool - LivingWell Health Club & Spa](https://www.livingwell.com/clubs/prague/)
* [Hotel Gym - LivingWell Health Club & Spa](https://www.livingwell.com/clubs/prague/)
* [CrossFit Meat Factory](https://maps.app.goo.gl/vqWhAWFTHRTMT8AX7)
...
This is an unofficial event. Topics are encouraged to be IETF-related and satirical or controversial in some way, although not mean-spirited. Anyone can participate in this social event. Please contact [krose@krose.org](mailto:krose@krose.org) if you wish to participate.

**Prague Sounds**

* https://www.praguesounds.cz/en/uvod

**Prague Alternativa Festival**

* https://www.alternativa-festival.cz/en/


**Prague Theater Festival in german language**

* https://www.theater.cz/de/programm/
