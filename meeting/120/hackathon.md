...
- **Project Info**
  ...
  - Testing [draft-ietf-tsvwg-careful-resume](https://datatracker.ietf.org/doc/draft-ietf-tsvwg-careful-resume/)
...
- **Project Info**
  ...
  - This IETF120 Hackathon will initially focus on generic topology queries, and compare IS-IS topology and OSPF topology drafts with RFC8345 versus RFC8345bis (gaps identified in RFC8345) approaches. 
...
###  A possible attempt to use sconepro for RTC scenario
- **Champions**
...
- **Project Info**
A catch all for all the DNS things that don't already have a specific project.
----
