...
### Management Issues
- Quick review of [BOF request wiki](https://datatracker.ietf.org/doc/bof-requests)? Seem to be several spam requests - Secretariat want to check which are real before we delete some as spam. (Liz)
