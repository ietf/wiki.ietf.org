...
## SRv6 Conformance (QSTR.SRv6_conf) – Liaison Flow Timeline

| Order | Liaison ID | Date (UTC) | Direction | From → To | Purpose | What happened | Link |
|------:|-----------:|------------|-----------|-----------|---------|---------------|------|
...
- This is a **single continuous liaison thread** focused on **SRv6 conformance verification**.
- The correction from **QSTR.MVC** to **QSTR.SRv6_conf** occurs between Liaison **1983** and **2016**.
