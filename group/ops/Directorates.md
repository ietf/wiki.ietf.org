...
description: 
published: true
date: 2026-08-21 T20:56:27.588Z
tags: 
editor: markdown
...
If you discover an important issue that would require feedback from the entire IETF community, you may send to ietf@ietf.org instead of (or in addition to) the other mailing lists. If there's something you want to share only with the ADs, send a separate, ADDITIONAL, message to them, flagged as private, but also send a note to the broader world, as above.

The OPS review template is now embedded as part of the review request.
Here's also a reference in github:
https://github.com/IETF-OPS-DIR/Review-Template/blob/main/opsdir-review-template.md

Some sample boilerplate like this:
```
...
### OPS DIR Review Check-list

A Check-list of possible questions/topics to address in an OPS-DIR review may be found in Appendix A of RFC 5706 or https://github.com/IETF-OPS-DIR/Review-Template/blob/main/review-checklist.md. Only include the questions that apply to your review. 
