...
|---|---|---|---|---|---|---|---|
| NRP Sub-TLV  | 2 | TBD |	yes |    | 
| NRP Sub-TLV Error Handling Procedures | 2 and 4 | TBD | yes |   | 
| Error handling of SR Policy TLV with malformed NRP-ID  |	4  | TBD | yes |   |
| NRP ID headend encapsulation for SRv6  | 3 | TBD | yes |     | 
