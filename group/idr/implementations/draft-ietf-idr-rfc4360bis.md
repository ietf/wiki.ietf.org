...
| Operations: Aggregated path contains union of Ext. Communities | 6 | TBD | No\[2\] |  | TBD |
| Operations: Carries both BGP Communities and BGP Ext. Communities | 6 | TBD | Yes |  | TBD | 
| Operations: Non-Transitive Ext. Communities removed at AS boundary | 6 | TBD | Yes |  |  TBD |
| Operations: Non-Transitive Ext. Communities not removed within BGP AS Confederation | 6 | TBD | Yes |  |  TBD | 
