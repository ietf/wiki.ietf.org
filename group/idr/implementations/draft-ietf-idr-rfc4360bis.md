...
## Implementations: 
Add list of implementations here
...
| Core Functionality | section |	Cisco IOS-XR |	Juniper	|
|---|---|---|---|---|---|---|---|
...
| Operations: Aggregated path contains union of Ext. Communities | 6 | TBD | TBD | 
