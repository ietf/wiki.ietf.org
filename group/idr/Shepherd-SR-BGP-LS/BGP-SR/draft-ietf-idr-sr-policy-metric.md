...
**current version:** -03 
**Early Allocation**: 20 [wiki Early Allocation](/group/idr/Early-Allocation-Status), needs early allocation.  Call awaits -04 version with 
**implementations:** TBD  
**bgp-ls draft:** none 
**Next step:** release -04 with issues fixed, and then do Early Allocation call (2 weeks) 
...
Please discussion with Ketan about the correct registry. The registry you have specified is at hte same level as all segment types.  
...
### Editorial Issues
#### Editorial issue in section 7.2
