...
> The BGP Directorate assists the ADs by raising the quality of BGP specifications before they are submitted to the IESG for publication.
{.is-info}
...
1) Neighbor FSM
2) Protocol messages, encoding, update packing, parsing and similar considerations
3) Changes to or impact on BGP decision process
4) Error handling and fault management (in the letter and spirit of RFC7606)
5) Design of new attributes (including new types of communities)
6) Scalability, performance and robustness
...
b) The document is complete/ready for implementations (and ideally before code points are allocated and implementations begin)
c) All major sections are complete beyond just the techncial procedures, encodings, etc. (i.e., IANA considerations, security considerations, and operational aspects are also covered)
