...
| [draft-ietf-pce-stateful-pce-vendor](https://datatracker.ietf.org/doc/draft-ietf-pce-stateful-pce-vendor) Waiting for authors to handle the WGLC comments | IPR response from Haomian is pending | Dhruv |
