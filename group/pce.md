...
| --- | --- | --- | --- |
| draft-dhody-pce-iana-update | In WG Adoption Call | IPR-1/1 | Julien |
...
| --- | --- | --- | --- |
| [draft-ietf-pce-pcep-color](https://datatracker.ietf.org/doc/draft-ietf-pce-pcep-color) | Waiting for authors to handle the WGLC comments | - | Andrew |
