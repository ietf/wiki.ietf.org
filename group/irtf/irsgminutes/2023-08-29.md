...
Corrections from: Colin Perkins
...
Amy Vezza told the group the NWCRG research group has been successfully concluded.

## Research Group Updates
### Recharter Progress for HRPC

Colin Perkins said the rechartering effort for HRPC is nearly complete. The recharter will be on the agenda for the IAB to approve in an upcoming IAB teleconference. He said if anyone had any final comments to let the chairs know soon.
...
Colin Perkins supported this becoming a semi-regular session if there is interest.
...
Colin said the IRTF doesn't have the same requirements around open participation as IETF, since it's a research body and not a standards developing organisation, and currently gives the chairs wide latitude in this regard.

Stephen said making sure that was written down for chairs to refer to would be helpful.

Colin agreed that having guidelines on what would ban someone from participating on a mailing list or in-person attendance at a meeting would be useful. He said he thought Lars [Eggert] was working on a document [draft-ecahc-moderation] on this subject and the IRTF may want to opt-in to be included.
