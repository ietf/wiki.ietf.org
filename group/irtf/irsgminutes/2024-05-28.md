...
Melinda Shore (GAIA Chair)
Allison Mankin (GAIA Chair)(joining at the end)
...
Colin continues by saying when Elliot's term as ISE rolled over and some of feedback that was received was that some people were a little happy about the way the independent stream has been handling national crypto algorithms so there's going to be some more discussion about that. 
